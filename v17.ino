...
//Clear all
 ...
 myGLCD.setFont(BVS_43); 
 myGLCD.setColor(255, 255, 255);
 myGLCD.print(dtostrf(LuftdruckWGT, 5, 1, str), 500, 260, 0);
 myGLCD.setFont(BVS_13);
 myGLCD.setColor(255, 0, 0);
 myGLCD.print(dtostrf(MaxLuftdruckWGT, 5, 1, str), 665, 260, 0);
 myGLCD.setColor(0, 0, 255);
 myGLCD.print(dtostrf(MinLuftdruckWGT, 5, 1, str), 665, 282, 0);
 myGLCD.setFont(BVS_43); 
 myGLCD.setColor(255, 255, 255);
 ...
 if ((LuftdruckWGT <= 980)&& (Temperatur >= 0)){ myGLCD.setColor(0, 255, 0);
 ...
 if ((LuftdruckWGT > 980) && (LuftdruckWGT <= 1000) && (Temperatur >= 0)) { myGLCD.setColor(0, 255, 0);
